...
!(function (j) {
  ...
  function Ke(e, t, n) {
    if (!(K(n) || B(n) || L(n)))
      throw (
        (j.console.error("Invalid call to Attr.set. Key ", t, ":: Value ", n, ":: Element ", e),
  ...
  var tt,
    ...
    at = {
      fromHtml: function (e, t) {
        ...
        if (((n.innerHTML = e), !n.hasChildNodes() || 1 < n.childNodes.length))
          throw (j.console.error("HTML does not have a single root node", e), new Error("HTML must have a single root node"));
    ...
    Et = [
      ...
      { name: "Opera", versionRegexes: [zt, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: fe("opera") },
    ...
    Nt = [
      ...
      { name: "OSX", search: fe("mac os x"), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
      ...
      { name: "ChromeOS", search: fe("cros"), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/] },
    ],
      ...
      if (!en.isElement(t) || !nr(t)) {
        ...
        if (!1 === en.isDocument(t)) {
          if (en.isText(t) && 0 < t.nodeValue.length) {
            ...
            en.isElement(t) &&
            (1 === (r = t.childNodes).length && nr(r[0]) && t.parentNode.insertBefore(r[0], t), r.length || fr(at.fromDom(t)))
          )
            return;
          e.remove(t);
        }
  ...
  function zr(e, t) {
    ...
    if (e) {
      for (e = e.split(","), t = t || 10, n = 0; n < e.length; n += 2)
        (r = String.fromCharCode(parseInt(e[n], t))), or[r] || ((o = "&" + e[n + 1] + ";"), (i[r] = o), (i[o] = r));
      return i;
    }
  }
  rr = zr(
    ...
    Br = function (e) {
      function t(e, t, n) {
        ...
        for (t = t || "", "string" == typeof (n = n || []) && (n = Hr(n)), o = (e = Hr(e)).length; o--; )
          (a = { attributes: r((i = Hr([u, t].join(" ")))), attributesOrder: i, children: r(n, Ar) }), (s[e[o]] = a);
      }
      function n(e, t) {
        var n, r, o, i;
      ...
      return Tr[e]
        ...
        : ((u = "id accesskey class dir lang style tabindex title role"),
          ...
          "html4" !== e &&
            ...
            (o += " audio canvas command datalist mark meter output picture progress time wbr media ruby bdi keygen")),
          "html5-strict" !== e &&
            ((u += " xml:lang"),
  ...
  function Lr(i) {
    function e(e, t, n) {
      ...
      return (
        r
          ...
          : (r = Tr[e]) || ((r = Mr(t, " ", Mr(t.toUpperCase(), " "))), (r = Dr(r, n)), (Tr[e] = r)),
        r
      );
    }
    var t,
    ...
    (r = Br((i = i || {}).schema)),
      ...
      (o = e("whitespace_elements", "pre script noscript style textarea media audio iframe object code")),
      ...
      (f = e("non_empty_elements", "td th iframe media audio object script pre code", u)),
              ...
              for (r = 0, o = (c = Hr(c, "|")).length; r < o; r++)
                if ((i = w.exec(c[r]))) {
                  ...
                  m &&
                    ...
                    x.test(l)
                      ? ((a.attributePatterns = a.attributePatterns || []), (u.pattern = N(l)), a.attributePatterns.push(u))
                      : (d[l] || h.push(l), (d[l] = u));
                }
            p || "@" !== s || ((p = d), (v = h)),
  ...
  function Ur(e, t) {
    ...
    return (
      ...
      !(r.stopImmediatePropagation = function () {
        ...
        })(r) && ((r.isDefaultPrevented = Yr), (r.isPropagationStopped = Yr), (r.isImmediatePropagationStopped = Yr)),
  ...
  var qr = "\ufeff",
    ...
    Wr = function (b, e) {
      var C,
        ...
        S = qr;
      for (
        b = b || {}, e && ((s = e.getValidStyles()), (l = e.getInvalidStyles())), t = ("\\\" \\' \\; \\: ; : " + S).split(" "), C = 0;
        C < t.length;
        C++
      )
        (N[t[C]] = S + C), (N[S + C] = t[C]);
      return {
        ...
        parse: function (e) {
          ...
          if (e) {
            ...
            t("border", "", !0),
              ...
              (m = "border-style"),
              (g = "border-color"),
              n((h = "border-width")) && n(m) && n(g) && ((p[d] = p[h] + " " + p[m] + " " + p[g]), delete p[h], delete p[m], delete p[g]),
        ...
        serialize: function (i, e) {
          ...
          if (e && s) t("*"), t(e);
            ...
            for (n in i)
              !(r = i[n]) ||
                (l && ((o = n), (a = e), (u = void 0), ((u = l["*"]) && u[o]) || ((u = l[a]) && u[o]))) ||
                (c += (0 < c.length ? " " : "") + n + ": " + r + ";");
          return c;
        },
      };
                ...
                : (d.hasMouseEnterLeave ||
                    ((s = d.mouseEnterLeave[c]) &&
                      (l = function (e) {
                        ...
                        n ||
                          (((e = Ur(e || h.event)).type = "mouseout" === e.type ? "mouseleave" : "mouseenter"),
                          (e.target = t),
  ...
  var eo,
    ...
    $o = {
      ...
      needsContext: new RegExp(
        "^" + Ho + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + Ho + "*((?:-\\d)?\\d*)" + Ho + "*\\)|)(?=[^-]|$)",
        "i"
      ),
    },
      ...
      CLASS: function (e) {
        ...
        return (
          ...
          ((t = new RegExp("(^|" + Ho + ")" + e + "(" + Ho + "|$)")) &&
            zo(e, function (e) {
              return t.test(
                ("string" == typeof e.className && e.className) || (typeof e.getAttribute != ko && e.getAttribute("class")) || ""
              );
            }))
        );
      },
          ...
          : function (e, t, n) {
              ...
              if (l) {
                ...
                if (((c = [v ? l.firstChild : l.lastChild]), v && d)) {
                  for (
                    u = (r = (o = l[bo] || (l[bo] = {}))[h] || [])[0] === wo && r[1], a = r[0] === wo && r[2], i = u && l.childNodes[u];
    ...
    for (
      ...
      if ((t = no.relative[e[u].type])) l = [si(li(l), t)];
        ...
        if ((t = no.filter[e[u].type].apply(null, e[u].matches))[bo]) {
          ...
          return di(
            1 < u && li(l),
            1 < u && ci(e.slice(0, u - 1).concat({ value: " " === e[u - 2].type ? "*" : "" })).replace(Vo, "$1"),
            t,
            u < n && hi(e.slice(u, n)),
            n < o && hi((e = e.slice(n))),
            n < o && ci(e)
  ...
  (ui.prototype = no.filters = no.pseudos),
    ...
    (io = Qo.tokenize = function (e, t) {
      ...
      for (a = e, u = [], c = no.preFilter; a; ) {
        for (i in ((n && !(r = Io.exec(a))) || (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
        (n = !1),
        (r = Fo.exec(a)) && ((n = r.shift()), o.push({ value: n, type: r[0].replace(Vo, " ") }), (a = a.slice(n.length))),
        no.filter))
  ...
  var zi = j.document,
    ...
    Ai = function (e, t, n, r) {
      ...
      if (gi(t)) t = pi(t, Pi(e[0]));
        ...
        if (((t = Fi.makeArray(t)), r)) for (o = t.length - 1; 0 <= o; o--) Ai(e, t[o], n, r);
    ...
    init: function (e, t) {
      ...
      if (gi(e)) {
        if (!(n = "<" === (o.selector = e).charAt(0) && ">" === e.charAt(e.length - 1) && 3 <= e.length ? [null, e, null] : Si.exec(e)))
          return Fi(t).find(e);
        if (n[1]) for (r = pi(e, Pi(t)).firstChild; r; ) Ei.call(o, r), (r = r.nextSibling);
        else {
  ...
  function Qi(a, u) {
    ...
    function w(e, n, r, o, i) {
      return y(e, function (e) {
        ...
        return (
          b(t, r), o && ("string" != typeof o && o.nodeType ? t.appendChild(o) : "string" == typeof o && C(t, o)), i ? t : e.appendChild(t)
        );
      });
    }
    function x(e, t, n) {
    ...
    var T = {},
            ...
            if (2 !== l.status)
              if (3 !== l.status) {
                if (
                  ...
                  "onload" in u && !((h = j.navigator.userAgent.match(/WebKit\/(\d*)/)) && parseInt(h[1], 10) < 536))
                )
                  (u.onload = f), (u.onerror = i);
                else {
                  if (0 < j.navigator.userAgent.indexOf("Firefox"))
                    return ((c = m.createElement("style")).textContent = '@import "' + e + '"'), d(), void b(c);
                  f();
                }
                var h;
                b(u), (u.href = e);
      ...
      _ = Wr({ url_converter: u.url_converter, url_converter_scope: u.url_converter_scope }, u.schema),
                ...
                (e = Jn._addCacheSuffix(e)),
                  M[e] ||
                    ...
                    (t = x(
                      "link",
                      ne(
                        ne({ rel: "stylesheet", type: "text/css", href: e }, u.contentCssCors ? { crossOrigin: "anonymous" } : {}),
  ...
  function fa() {
    ...
    var r = this,
      ...
      e = function (e, t, n) {
        void 0 === n && (n = "added"),
          te(f, e) && "added" === n ? t() : te(l, e) && "loaded" === n ? t() : i.push({ name: e, state: n, callback: t });
      };
    return {
      items: o,
      urls: l,
  ...
  function Ka(e) {
    return e
      ? { left: Au(e.left), top: Au(e.top), bottom: Au(e.bottom), right: Au(e.right), width: Au(e.width), height: Au(e.height) }
  ...
  var cu,
    ...
    Nu = en.matchNodeNames(["img", "input", "textarea", "hr", "iframe", "media", "audio", "object"]),
    ...
    Wu = function (e) {
      ...
      function t(e, t) {
        ...
        0 < t && (n.setStart(e, t - 1), n.setEnd(e, t), iu(n) || r(uu($u(n), !1))),
          t < e.data.length && (n.setStart(e, t), n.setEnd(e, t + 1), iu(n) || r(uu($u(n), !0)));
      }
      var n,
        o,
        i = [];
      ...
      en.isText(a)
        ? c.push(
            n
              ? (function (e, t, n) {
                  var r, o;
                  for (o = e(t.data.slice(0, n)).length, r = t.previousSibling; r && en.isText(r); r = r.previousSibling)
                    o += e(r.data).length;
                  return o;
                })(t, a, u)
              : u
          )
        : (u >= (i = a.childNodes).length && i.length && ((s = 1), (u = Math.max(0, i.length - 1))), c.push(e.nodeIndex(i[u], n) + s));
      a && a !== l;
      a = a.parentNode
    )
  ...
  function bc(e, t, n) {
    ...
    return (
      ...
      (c.bottom += i),
      (c.width = 1),
      0 < (a = t.offsetWidth - t.clientWidth) && (n && (a *= -1), (c.left += a), (c.right += a)),
      c
    );
  }
  function Cc(e, i, a, t) {
    var n,
      ...
      f = function () {
        n = Ln.setInterval(function () {
          t()
            ? Fi("div.mce-visual-caret", i).toggleClass("mce-visual-caret-hidden")
      ...
      show: function (t, e) {
        ...
        if (!a(e))
          return (
            ...
            Ls(u.nextSibling) ? (r.setStart(u, 0), r.setEnd(u, 0)) : (r.setStart(u, 1), r.setEnd(u, 1)),
            r
          );
    ...
    if (s) {
      if (
        ...
        a &&
          ...
          en.isText(a) &&
          !Kn.opera &&
          ((o = a.nodeValue.length), a.appendData(i.nodeValue), e.remove(i), (c = ((u = a), o)));
      }
    ...
    if (
      ...
      for (
        a < (i = u.childNodes).length
          ...
          : ((u = i[i.length - 1]), (r = new Ui(u, e.getParent(u, e.isBlock))).next(!0)),
          o = r.current();
        o;
        o = r.next()
      )
  ...
  function Al(e, t, n, r) {
    ...
    var o = t.startContainer,
      ...
      c = e.dom;
    return (
      en.isElement(o) && o.hasChildNodes() && ((o = eu(o, i)), en.isText(o) && (i = 0)),
      en.isElement(a) && a.hasChildNodes() && ((a = eu(a, t.collapsed ? u : u - 1)), en.isText(a) && (u = a.nodeValue.length)),
      (o = wl(c, o)),
      (a = wl(c, a)),
      ...
      (n[0].inline || n[0].block_expand) &&
        ((n[0].inline && en.isText(o) && 0 !== i) || (o = Tl(c, n, o, i, a, u, !0)),
        (n[0].inline && en.isText(a) && u !== a.nodeValue.length) || (a = Tl(c, n, o, i, a, u, !1))),
      n[0].selector && !1 !== n[0].expand && !n[0].inline && ((o = Sl(c, n, t, o, "previousSibling")), (a = Sl(c, n, t, a, "nextSibling"))),
      (n[0].block || n[0].selector) &&
        ((o = kl(e, n, o, "previousSibling")),
        (a = kl(e, n, a, "nextSibling")),
        n[0].block && (c.isBlock(o) || (o = Tl(c, n, o, i, a, u, !0)), c.isBlock(a) || (a = Tl(c, n, o, i, a, u, !1)))),
  ...
  var Rl,
    ...
    Vl = function (e, t, n) {
      ...
      return ((zc(e) && u.isAtEnd()) || (Ec(e) && u.isAtStart())) && ((r = Sc(r, e, $(!0), n, !0)), Ll(r, n))
        ? Xs(e, r)
        : ((o = Sc(r, e, Ll, n)),
          !(a = Yn.last(
            G(
  ...
  var df = (function IN(n, r) {
    ...
    hf = /^[ \t\r\n]*$/,
    mf = { "#text": 3, "#comment": 8, "#cdata": 4, "#pi": 7, "#doctype": 10, "#document-fragment": 11 },
    gf =
            ...
            if (
              (function (e, t) {
                return (
                  ...
                  (/^data:image\//i.test(t) ? !1 === e.allow_svg_data_urls && /^data:image\/svg\+xml/i.test(t) : /^data:/i.test(t))
                );
              })(q, u)
            )
              return;
          ...
          if ((H < o.index && X(L(i.substr(H, o.index - H))), (u = o[7])))
            ...
            if (!y || (b = $.getElementRule(u))) {
              if (
                ...
                (x = o[9])
                  ? ((h = -1 !== x.indexOf("data-mce-type")) && m && (C = !1), ((s = []).map = {}), x.replace(R, r))
                  : ((s = []).map = {}),
                y && !h)
              ) {
                if (
                  ...
                  for (l = k.length; l--; )
                    (d = (w = k[l]).name), "{$uid}" === (_ = w.value) && (_ = "mce_" + P++), (s.map[d] = _), s.push({ name: d, value: _ });
                if (S)
                  for (l = S.length; l--; )
                    (d = (w = S[l]).name) in s.map ||
                      ("{$uid}" === (_ = w.value) && (_ = "mce_" + P++), (s.map[d] = _), s.push({ name: d, value: _ }));
                if (N) {
            ...
            if ((c = D[u])) {
              (c.lastIndex = H = o.index + U.length),
                (H = (o = c.exec(i)) ? (C && (f = i.substr(H, o.index - H)), o.index + o[0].length) : ((f = i.substr(H)), i.length)),
  ...
  function wf(e, t, n) {
    ...
    return (
      "text" === t.format || mr(at.fromDom(n)) ? (t.content = r) : (t.content = Jn.trim(r)),
          ...
          var h = function (e) {
            ...
            if (l) l(e);
              ...
              if (
                ...
                (n = e.shortEnded),
                (r = e.attributes),
                d && r && 1 < r.length && (((a = []).map = {}), (s = m.getElementRule(e.name))))
              ) {
                for (u = 0, c = s.attributesOrder.length; u < c; u++)
                  (o = s.attributesOrder[u]) in r.map && ((i = r.map[o]), (a.map[o] = i), a.push({ name: o, value: i }));
              ...
              return (
                0 === n.length || /^\s+$/.test(n)
                  ? ((i = '<br data-mce-bogus="1">'),
                    ...
                    (n =
                      (o = us(e)) && e.schema.isValidChild(t.nodeName.toLowerCase(), o.toLowerCase())
                        ? ((n = i), e.dom.createHTML(o, e.settings.forced_root_block_attrs, n))
                        : n || '<br data-mce-bogus="1">'),
                    Yf(e, n),
                    e.fire("SetContent", r))
                  : ("raw" !== r.format &&
                      (n = zf({ validate: e.validate }, e.schema).serialize(e.parser.parse(n, { isRootContent: !0, insert: !0 }))),
  ...
  function Qf(e, t) {
    ...
    e.destroyed ||
      (t || e.removed
        ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), Zf(n), Zf(r)),
          (function (e) {
            var t = e.formElement;
            t &&
  ...
  function od(e, t, n, r, o) {
    var i = e
        ? {
            mobile: (function (e, t) {
              var n = { resize: !1, toolbar_mode: nd(e, "scrolling"), toolbar_sticky: !1 };
  ...
  function ud(e, t, n, r) {
    ...
    return "hash" === r
      ? (function (e) {
          ...
          return (
            "string" == typeof e
              ? U(0 < e.indexOf("=") ? e.split(/[;,](?![^=;,]*(?:[;,]|$))/) : e.split(","), function (e) {
                  var t = e.split("=");
    ...
    Qd = function (e, t, n) {
      var r = at.fromDom(e.getBody()),
        ...
        i = (function (e, t, n, r) {
          ...
          return { x: n - (e ? o.left + t.dom().clientLeft + Jd(t) : 0), y: r - (e ? o.top + t.dom().clientTop + Zd(t) : 0) };
        })(e.inline, o, t, n);
      return (function (e, t, n) {
        var r = Yd(e),
          o = Gd(e);
  ...
  function hh(r, a) {
    ...
    function _(e) {
      ...
      (t = e.screenX - d),
        ...
        (b = b < 5 ? 5 : b),
        (C = C < 5 ? 5 : C),
        (M(u) && !1 !== Hs(a) ? !ph.modifierPressed(e) : ph.modifierPressed(e)) &&
        ...
        (t = A.scrollWidth - w) + (n = A.scrollHeight - x) !== 0 && z.setStyles(s, { left: r - t, top: o - n }),
        i ||
          ((function (e, t, n, r) {
    ...
    function o(e) {
      ...
      i ||
        ...
        t((n = z.$(n).closest("table,img,figure.image,hr")[0]), A) && (V(), t(r.getStart(!0), n) && t(r.getEnd(!0), n)) ? B(n) : P());
    }
    function O(e) {
      return vh(
        (function (e, t) {
                    ...
                    e.stopImmediatePropagation(),
                      ...
                      (function (e) {
                        (d = e.screenX),
                          ...
                          z.bind(N, "mouseup", H),
                          S !== N && (z.bind(S, "mousemove", _), z.bind(S, "mouseup", H)),
                          (s = z.add(A, "div", { class: "mce-resize-helper", "data-mce-bogus": "all" }, p + " &times; " + v));
                      })(e);
                  }),
                  (t.elm = n),
                  z.setStyles(n, { left: r * t[0] + m - n.offsetWidth / 2, top: o * t[1] + g - n.offsetHeight / 2 });
              })
            : P(),
  ...
  function jh(e, t) {
    for (var n = e.rows(), r = 0; r < n.length; r++)
      for (var o = n[r].cells(), i = 0; i < o.length; i++) if (ve(o[i], t)) return D.some(km(i, r));
    return D.none();
  }
  ...
  var dm = (function FN(r, o) {
    ...
    bm = function (e, t, n) {
      ...
      if (i.caretPositionFromPoint)
        (o = i.caretPositionFromPoint(e, t)) && ((r = n.createRange()).setStart(o.offsetNode, o.offset), r.collapse(!0));
    ...
    Pm = function (e, t) {
      ...
      if ("text" === t.format)
        return (function (r) {
          return D.from(r.selection.getRng())
            .map(function (e) {
              var t = r.dom.add(r.getBody(), "div", { "data-mce-bogus": "all", style: "overflow: hidden; opacity: 0;" }, e.cloneContents()),
      ...
      var n = (function (e, t) {
        var n,
          ...
          a = Cm(e, Rm(i));
        return (
          (n = t.contextual ? Bm(at.fromDom(e.getBody()), a).dom() : r.cloneContents()) && o.appendChild(n),
      ...
      h = function () {
        ...
        try {
          (t = d()) &&
            ...
            (n = 0 < t.rangeCount ? t.getRangeAt(0) : t.createRange ? t.createRange() : o.createRange());
        } catch (a) {}
        return (
          (n = (n = Cm(s, [n])[0]) || (o.createRange ? o.createRange() : o.body.createTextRange())).setStart &&
        ...
        getSelectedBlocks: function (e, t) {
          return (function (e, t, n, r) {
            ...
            if (
              ...
              for (var u = new Ui((o = n), i); (o = u.next()) && o !== r; ) e.isBlock(o) && a.push(o);
          ...
          t = hd(
            {
              ...
              start: function (e, t, n) {
                ...
                if ((n = v ? A.getElementRule(e) : {})) {
                  ...
                  if ((f && C[e] && (f = !1), n.removeEmpty && Km(A, g, C, d) && !d.attr("name") && !d.attr("id")))
                        ...
                        if (h[n.name] && "li" === n.parent.name) {
                          ...
                          if (r && 1 < o.length) {
                            for (o.reverse(), i = a = O(o[0].clone()), s = 0; s < o.length - 1; s++) {
                              for (
                                A.isValidChild(a.name, o[s].name) ? ((u = O(o[s].clone())), a.append(u)) : (u = a), c = o[s].firstChild;
                                c && c !== o[s + 1];
                            ...
                            Km(A, l, f, i) ? r.insert(n, o[0], !0) : (r.insert(i, o[0], !0), r.insert(n, i)),
                              (r = o[0]),
                              (Km(A, l, f, r) || ng(r, "br")) && r.empty().remove();
                          } else if (n.parent) {
                            if ("li" === n.name) {
            ...
            b &&
              ...
              (function () {
                ...
                if (A.isValidChild(k.name, b.toLowerCase())) {
                  for (; r; )
                    (t = r.next),
                      3 === r.type || (1 === r.type && "p" !== r.name && !l[r.name] && !r.attr("data-mce-type"))
                        ? (n || ((n = S(b, 1)).attr(T.forced_root_block_attrs), k.insert(n, r)), n.append(r))
                        : (e(n), (n = null)),
                      (r = t);
                  e(n);
                }
          ...
          e.addNodeFilter("br", function (e, t, n) {
            ...
            for (d.body = 1, r = 0; r < f; r++)
              if (((i = (o = e[r]).parent), d[o.parent.name] && o === i.lastChild)) {
                ...
                o &&
                  (o.remove(),
                  Km(p, h, m, i) && (s = p.getElementRule(i.name)) && (s.removeEmpty ? i.remove() : s.paddEmpty && Wm(g, n, d, i)));
              } else {
          ...
          g.validate &&
            ...
            e.addAttributeFilter("class", function (e) {
              for (var t, n, r, o, i, a, u, c = e.length, s = p.getValidClasses(); c--; ) {
                for (n = (t = e[c]).attr("class").split(" "), i = "", r = 0; r < n.length; r++)
                  (o = n[r]),
                    (u = !1),
                    (a = s["*"]) && a[o] && (u = !0),
                    (a = s[t.name]),
    ...
    ug = function (t, c, s) {
      t.addAttributeFilter("data-mce-tabindex", function (e, t) {
        ...
        t.addAttributeFilter("class", function (e) {
          for (var t, n, r = e.length; r--; )
            (n = (t = e[r]).attr("class")) &&
              ((n = t.attr("class").replace(/(?:^|\s)mce-item-\w+(?!\S)/g, "")), t.attr("class", 0 < n.length ? n : null));
        }),
          ...
          for (var t, n = e.length; n--; )
            (t = e[n]),
              c.preserve_cdata && 0 === t.value.indexOf("[CDATA[")
                ? ((t.name = "#cdata"), (t.type = 4), (t.value = s.decode(t.value.replace(/^\[CDATA\[|\]\]$/g, ""))))
              ...
              0 !== r.src.indexOf("blob:")
                ? ((i = dg(r.src).data),
                  (a = n.findFirst(function (e) {
                    ...
                    : lg(r.src).then(
                        function (e) {
                          (a = n.create(eg(), e, i)), n.add(a), o({ image: r, blobInfo: a });
                        },
                        function (e) {
                          t(e);
                        }
                ...
                : lg(r.src).then(
                    function (t) {
                      fg(t).then(function (e) {
                        (i = dg(e).data), (a = n.create(eg(), t, i)), n.add(a), o({ image: r, blobInfo: a });
                      });
                    },
                    function (e) {
                      t(e);
  ...
  function pg(o) {
    ...
    function r(e, t, n) {
      for (
        var r = 0;
        -1 !== (r = e.indexOf(t, r)) && ((e = e.substring(0, r) + n + e.substr(r + t.length)), (r += n.length - t.length + 1)), -1 !== r;
    ...
    function c(n) {
      return (
        (f = f || gg(m, { url: ws(o), basePath: xs(o), credentials: zs(o), handler: Es(o) })),
        p().then(
          t(function (r) {
            ...
            return f.upload(e, a).then(
              t(function (e) {
                var t = X(e, function (e, t) {
                  var n = r[t].image;
                  return e.status && Cs(o) ? u(n, e.url) : e.error && fh.uploadError(o, e.error), { element: n, status: e.status };
                });
                return n && n(t), t;
              })
            );
              ...
              (n = e.name || t),
              {
                ...
                filename: $(
                  n +
                    "." +
                    (function (e) {
                      return { "image/jpeg": "jpg", "image/jpg": "jpg", "image/gif": "gif", "image/png": "png" }[e.toLowerCase()] || "dat";
                    })(e.blob.type)
                ),
                blob: $(e.blob),
                base64: $(e.base64),
    ...
    return (
      t === r && en.isText(t)
        ? 0 < n &&
          ...
          n < o ? ((t = r = Eg(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0)) : (o = 0))
        : (en.isText(t) && 0 < n && n < t.nodeValue.length && ((t = Eg(t, n)), (n = 0)),
          en.isText(r) && 0 < o && o < r.nodeValue.length && (o = (r = Eg(r, o).previousSibling).nodeValue.length)),
      ...
      e.replaceData(
        ...
        (function (n, r, o) {
          return y(
            ...
            function (e, t) {
              return cl(t) || Yl(t)
                ? e.previousCharIsSpace || ("" === e.str && r) || (e.str.length === n.length - 1 && o)
  ...
  function Ug(e) {
    ...
    return Xe(t, { id: fp, "data-mce-bogus": "1", "data-mce-type": "format-caret" }), e && Bt(t, at.fromText(lp)), t;
  }
  function jg(e, t, n) {
    void 0 === n && (n = !0);
    var r = e.dom,
  ...
  function qg(e, t, n) {
    ...
    var r = e.dom,
      o = e.selection;
    if (t) jg(e, t, n);
    else if (!(t = fc(e.getBody(), o.getStart()))) for (; (t = r.get(fp)); ) jg(e, t, !1);
  }
  function $g(e, t, n) {
    var r = e.dom,
    ...
    o && r.isEmpty(o)
      ...
      : (ep(at.fromDom(n)), r.isEmpty(n) ? n.parentNode.replaceChild(t, n) : r.insertAfter(t, n));
  }
  function Wg(e, t) {
    ...
    t.on("mouseup keydown", function (e) {
      !(function (e, t) {
        var n = e.selection,
          r = e.getBody();
        qg(e, null, !1),
          (8 !== t && 46 !== t) || !n.isCollapsed() || n.getStart().innerHTML !== lp || qg(e, fc(r, n.getStart())),
  ...
  function vp(e, t, n) {
    ...
    return (
      en.isText(r) && n && o >= r.nodeValue.length && (r = new Ui(r, e.getBody()).next() || r),
    ...
    if ("all" !== r.remove) {
      Op(r.styles, function (e, t) {
        (e = vl(a, gl(e, o), t)),
          ...
          (!r.remove_similar && i && !Hp(yl(a, i, t), e)) || a.setStyle(u, t, ""),
          (n = !0);
      }),
        n && "" === a.getAttrib(u, "style") && (u.removeAttribute("style"), u.removeAttribute("data-mce-style")),
                ...
                ((n.list_block && Hp(e, n.list_block)) ||
                  Op(Jn.grep(e.childNodes), function (e) {
                    ml(t, a, e.nodeName.toLowerCase())
                      ? r
                        ? r.appendChild(e)
                        : ((r = yp(i, e, a)), i.setAttribs(r, t.settings.forced_root_block_attrs))
                      : (r = 0);
                  }))
              : i.isBlock(e) &&
                !i.isBlock(o) &&
                (Cp(i, e, !1) || Cp(i, e.firstChild, !0, !0) || e.insertBefore(i.create("br"), e.firstChild),
                Cp(i, e, !0) || Cp(i, e.lastChild, !1, !0) || e.appendChild(i.create("br")))),
  ...
  function xp(u, n, a, e, r) {
      ...
      if (f.split) {
        if (((o = Ng(o)), (t = vp(u, o, !0)) !== (n = vp(u, o)))) {
          if (
            ...
            return c(bp(h, i, !0, "span", { id: "_start", "data-mce-type": "bookmark" })), void s(!0);
          }
          if (pp(h, n, t)) {
            i = D.from(n.lastChild).getOr(n);
            return c(bp(h, i, !1, "span", { id: "_end", "data-mce-type": "bookmark" })), void s(!1);
          }
        ...
        Op(e, function (e) {
          g(e),
            en.isElement(e) &&
              ...
              wp(u, { deep: !1, exact: !0, inline: "span", styles: { textDecoration: "underline" } }, null, e);
        });
      });
    }
    var o,
      ...
      g = function (e) {
        var t, n, r, o, i;
        if (
          (en.isElement(e) && h.getContentEditable(e) && ((o = d), (d = "true" === h.getContentEditable(e)), (i = !0)),
    ...
    if (e) ll(e) ? ((i = h.createRng()).setStartBefore(e), i.setEndAfter(e), t(i)) : t(e);
      ...
      m.isCollapsed() && f.inline && !h.select("td[data-mce-selected],th[data-mce-selected]").length
        ? (function (e, t, n, r) {
            var o,
              i,
              a,
              ...
              m = d.getRng();
            for (
              o = m.startContainer, i = m.startOffset, 3 === (c = o).nodeType && (i !== o.nodeValue.length && (u = !0), (c = c.parentNode));
              c;
  ...
  var Dp = Jn.each,
          ...
          nf(c, e, function (e) {
            var a,
              u = function (e) {
                ...
                if (
                  (en.isElement(e) && c.getContentEditable(e) && ((n = h), (h = "true" === c.getContentEditable(e)), (t = !0)), pl(r, "br"))
                )
                ...
                if (C.wrapper && op(m, e, g, p)) a = 0;
                  ...
                  (C.inline && c.isBlock(e))
                    ? ((a = 0), Ip(Jn.grep(e.childNodes), u), t && (h = n), (a = 0))
                    : (a || ((a = c.clone(f, !1)), e.parentNode.insertBefore(a, e), d.push(a)), a.appendChild(e));
                }
              };
            Ip(e, u);
          }),
          ...
          Ip(d, function (e) {
            ...
            (!(1 < d.length) && c.isBlock(e)) || 0 !== n)
              ? (C.inline || C.wrapper) &&
                (C.exact ||
                  1 !== n ||
                  ((i = t((o = e))) && !Xl(i) && bg(c, i, C) && ((a = c.clone(i, !1)), v(a), c.replace(a, o, !0), c.remove(i, !0)),
                  (e = a || o)),
                Ap(m, b, p, e),
                (function (t, n, r, o, i) {
                ...
                (function (e, t, n, r) {
                  t.styles &&
                    ...
                    Pp(r, Sp(e, "fontSize"), kp(e, "backgroundColor", gl(t.styles.backgroundColor, n)));
                })(c, C, p, e),
                (function (e, t, n, r) {
                  ("sub" !== t.inline && "sup" !== t.inline) ||
                    (Pp(r, Sp(e, "fontSize"), kp(e, "fontSize", "")), e.remove(e.select("sup" === t.inline ? "sub" : "sup", r), !0));
                })(c, C, 0, e),
                (function (e, t, n, r) {
        ...
        if (C) {
          if (r) ll(r) ? y(b, r) || ((n = i.createRng()).setStartBefore(r), n.setEndAfter(r), e(i, Al(m, n, b), 0, !0)) : e(i, r, 0, !0);
            ...
            !(function (e, t, n) {
              ...
              var l = /[^\s\u00a0\u00ad\u200b\ufeff]/;
              c && 0 < a && a < c.length && l.test(c.charAt(a)) && l.test(c.charAt(a - 1))
                ? ((u = s.getBookmark()),
                  r.collapse(!0),
            ...
            m.settings.forced_root_block || !b[0].defaultBlock || i.getParent(u, i.isBlock) || Fp(m, b[0].defaultBlock),
    ...
    qp = function (r) {
      ...
      return (
        Jn.each("p h1 h2 h3 h4 h5 h6 div address pre div dt dd samp".split(/\s/), function (e) {
          ...
          if (
            !(
              ("background-color" === e &&
                ...
                ((t = Wv.getStyle(n.getBody(), e, !0)), "#ffffff" === Wv.toHex(t).toLowerCase())) ||
      ...
      a = {
        ...
        undo: function () {
          return (function (e, t, n, r) {
            ...
            return (
              ...
              0 < r.get() && (r.set(r.get() - 1), (o = t.data[r.get()]), ny(e, o, !0), e.setDirty(!0), e.fire("Undo", { level: o })),
              o
            );
          })(n, a, o, i);
        },
        redo: function () {
          return (function (e, t, n) {
            var r;
            return (
              t.get() < n.length - 1 && (t.set(t.get() + 1), (r = n[t.get()]), ny(e, r, !1), e.setDirty(!0), e.fire("Redo", { level: r })),
              r
            );
          })(n, i, a.data);
        },
      ...
      (function (n, r, o) {
        ...
        n.on("init", function () {
          ...
          n.on("keyup", function (e) {
            var t = e.keyCode;
            e.isDefaultPrevented() ||
              (((33 <= t && t <= 36) || (37 <= t && t <= 40) || 45 === t || e.ctrlKey) && (i(), n.nodeChanged()),
  ...
  var jv,
    ...
    ny = function (e, t, n) {
      "fragmented" === t.type ? Qv(t.fragments, e.getBody()) : e.setContent(t.content, { format: "raw" }),
    ...
    oy = [9, 27, ph.HOME, ph.END, 19, 20, 44, 144, 145, 33, 34, 45, 16, 17, 18, 91, 92, 93, ph.DOWN, ph.UP, ph.LEFT, ph.RIGHT].concat(
      Kn.browser.isFirefox() ? [224] : []
    ),
    ...
    for (var o, i, a, u, c, s, l = Ys(n), f = r, d = []; f && ((c = l), (s = f), (o = t === Lc.Forwards ? c.next(s) : c.prev(s))); ) {
      if (en.isBr(o.getNode(!1)))
        return t === Lc.Forwards
          ? { positions: rb(t, d).concat([o]), breakType: Fy.Br, breakAt: D.some(o) }
  ...
  function sb(e, t, n, r) {
    ...
    if (((s = c.left), (u = Ay(a, s)) && Lw(u.node)))
      return (l = Math.abs(s - u.left)), (f = Math.abs(s - u.right)), Dy(e, t, u.node, l < f, !0);
    if (d) {
  ...
  var Ow = d(ob, Ku.isAbove, -1),
          ...
          (function (e, t, n) {
            ...
            $w(
              [
                ...
                { keyCode: ph.RIGHT, ctrlKey: !r.isOSX(), altKey: r.isOSX(), action: xy.moveNextWord(e, t) },
                { keyCode: ph.LEFT, ctrlKey: !r.isOSX(), altKey: r.isOSX(), action: xy.movePrevWord(e, t) },
    ...
    Tx = function (a, e) {
      function t(e) {
        ...
        if (((r = t = e || "TABLE" === m || "HR" === m ? y.create(e || p) : s.cloneNode(!1)), !1 === fs(a)))
      ...
      function r() {
        (f = /^(H[1-6]|PRE|FIGURE)$/.test(m) && "HGROUP" !== g ? t(p) : t()),
          ds(a) && $C(y, h) && y.isEmpty(s) ? (f = y.split(h, s)) : y.insertAfter(f, s),
          xx(a, f);
      }
      var o,
        u,
      ...
      en.isElement(c) &&
        ...
        (u = KC(y, c)) &&
            ...
            (c = (function (e, t, n, r, o) {
              ...
              if (!(a = d.getParent(r, d.isBlock)) || !$C(d, a)) {
                if (
                  ...
                  return (i = d.create(f)), YC(e, i), a.appendChild(i), n.setStart(i, 0), n.setEnd(i, 0), i;
                for (c = r; c.parentNode !== a; ) c = c.parentNode;
                for (; c && !d.isBlock(c); ) c = (u = c).previousSibling;
                if (u && e.schema.isValidChild(l, f.toLowerCase())) {
                  for (i = d.create(f), YC(e, i), u.parentNode.insertBefore(i, u), c = u; c && !d.isBlock(c); )
          ...
          "LI" !== (g = h ? h.nodeName.toUpperCase() : "") || x || ((h = (s = h).parentNode), (m = g)),
          /^(LI|DT|DD)$/.test(m) && y.isEmpty(s)
            ...
            : (p && s === a.getBody()) ||
              ...
              Pa(s)
                ...
                ? r()
                : n(!0)
                ? ((f = s.parentNode.insertBefore(t(), s)), xx(a, qC(s, "HR") ? f : s))
                : ((o = (function (e) {
                    var t = e.cloneRange();
                    return (
    ...
    Vx = function (t) {
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t) {
            $w([{ keyCode: ph.SPACEBAR, action: qw(Mw, e) }], t).each(function (e) {
              t.preventDefault();
            });
          })(t, e);
      });
    ...
    "onselectionchange" in r.getDoc() ||
      ...
      r.on("SelectionChange", function () {
        ...
        !e ||
          ...
          (Ih(r) && !t.isSameElementPath(e) && r.dom.isChildOf(e, r.getBody()) && r.nodeChanged({ selectionChange: !0 }));
      }),
    ...
    var v,
      ...
      u = function (e) {
        var t = g.schema.getShortEndedElements(),
          ...
          a = e.endOffset;
        return (
          te(t, r.nodeName.toLowerCase()) ? (0 === o ? n.setStartBefore(r) : n.setStartAfter(r)) : n.setStart(r, o),
      ...
      c = function (e, t) {
        ...
        if (
          ...
          (a = e.startOffset),
          (u = e.endOffset),
          3 === i.nodeType && 0 === a && Hz(i.parentNode) && ((i = i.parentNode), (a = h.nodeIndex(i)), (i = i.parentNode)),
          1 !== i.nodeType)
        )
          return null;
        if ((u === a + 1 && i === e.endContainer && (n = i.childNodes[a]), !Hz(n))) return null;
        if (((l = f = n.cloneNode(!0)), (c = g.fire("ObjectSelected", { target: n, targetClone: l })).isDefaultPrevented())) return null;
        (r = Ta(at.fromDom(g.getBody()), "#" + b).fold(
          ...
          l === f && Kn.ie
            ? (r.empty().append('<p style="font-size: 0" data-mce-bogus="all">\xa0</p>').append(l),
              ...
              e.setEndAfter(l))
            : (r.empty().append($r).append(l).append($r), e.setStart(r[0].firstChild, 1), e.setEnd(r[0].lastChild, 0)),
      ...
      s = function () {
        v && (v.removeAttribute("data-mce-selected"), Ta(at.fromDom(g.getBody()), "#" + b).each(Pt), (v = null)),
        ...
        (function () {
          g.on("mouseup", function (e) {
            ...
            g.on("click", function (e) {
              var t;
              (t = ez(g, e.target)) &&
                (Hz(t) && (e.preventDefault(), g.focus()), Oz(t) && g.dom.isChildOf(t, g.selection.getNode()) && s());
            }),
    ...
    return (
      a.on("keydown", function (e) {
        ...
        if (
          ...
          ((n = (t = l.getRng()).startContainer), (r = t.startOffset), (o = s.getRoot()), (i = n), t.collapsed && 0 === r)
        ) {
          for (; i && i.parentNode && i.parentNode.firstChild === i && i.parentNode !== o; ) i = i.parentNode;
          "BLOCKQUOTE" === i.tagName &&
            (a.formatter.toggle("blockquote", null, i), (t = s.createRng()).setStart(n, 0), t.setEnd(n, 0), l.setRng(t));
        }
      }),
      a.on("keydown", function (e) {
        var t,
      ...
      g &&
        ...
        a.on("click", function (e) {
          ...
          /^(IMG|HR)$/.test(t.nodeName) &&
            ...
            "A" === t.nodeName && s.hasClass(t, "mce-item-anchor") && (e.preventDefault(), l.select(t));
        }),
        f.forced_root_block &&
          a.on("init", function () {
        ...
        a.on("dragstart", function (e) {
          !(function (e) {
            ...
            e.dataTransfer &&
              ...
              0 < (t = a.selection.getContent()).length && ((n = p + escape(a.id) + "," + escape(t)), e.dataTransfer.setData(v, n)));
          })(e);
        }),
          ...
          if (!u(e)) {
            var t = (function (e) {
              ...
              return e.dataTransfer && (t = e.dataTransfer.getData(v)) && 0 <= t.indexOf(p)
                ? ((t = t.substr(p.length).split(",")), { id: unescape(t[0]), html: unescape(t[1]) })
                : null;
            })(e);
            if (t && t.id !== a.id) {
              e.preventDefault();
      ...
      h &&
        ...
        a.on("keypress", function (e) {
          ...
          if (!u(e) && (8 === e.keyCode || 46 === e.keyCode) && C())
            return (t = b()), a.getDoc().execCommand("delete", !1, null), t(), e.preventDefault(), !1;
        }),
  ...
  function oz(e, t) {
    var n = e.editorManager.translate("Rich Text Area. Press ALT-0 for help."),
      r = (function (e, t, n, r) {
        ...
        return (
          Xe(o, r), Xe(o, { id: e + "_ifr", frameBorder: "0", allowTransparency: "true", title: t }), ya(o, "tox-edit-area__iframe"), o
        );
  ...
  function yz(e, t) {
    ...
    n.collapsed &&
      ...
      en.isText(r) &&
      (r.insertData(o - 1, " "), r.deleteData(o, 1), n.setStart(r, o), n.setEnd(r, o), e.selection.setRng(n)),
  ...
  function bz(e, t, n) {
    ...
    if (
      ...
      e.fire("SetContent", { content: c.content, format: "html", selection: !0, paste: n.paste });
    else {
            ...
            return (
              ...
              3 === n.nodeType &&
                ...
                (n.data[r] === $r
                  ...
                  : n.data[r - 1] === $r && (n.deleteData(r - 1, 1), /[\u00a0| ]$/.test(t) || (t = " " + t))),
              t
            );
      ...
      if (((u = r.parse(t, y)), !0 === n.paste && $z(e.schema, u) && Kz(g, i)))
        return (l = Wz(o, g, e.selection.getRng(), u)), e.selection.setRng(l), void e.fire("SetContent", c);
      if (
        ((function (e) {
          ...
          if (e) {
            ...
            (i = e.previousSibling) && 3 === i.nodeType
              ? (s.setStart(i, i.nodeValue.length),
                Kn.ie || ((a = e.nextSibling) && 3 === a.nodeType && (i.appendData(a.data), a.parentNode.removeChild(a))))
  ...
  var Tz = function (e, t) {
    ...
    Pz = function (t, e) {
      ...
      o.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        t.readonly ||
          (t.inline && "static" === Bz.getStyle(n, "position", !0) && (n.style.position = "relative"),
          ...
          return (
            ...
            e.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div", function (e) {
              for (var t, n = e.length, r = u.schema.getNonEmptyElements(); n--; )
                (t = e[n]).isEmpty(r) && 0 === t.getAll("br").length && (t.append(new gf("br", 1)).shortEnded = !0);
            }),
            e
          );
        })(t)),
        ...
        o.browser_spellcheck || o.gecko_spellcheck || ((a.body.spellcheck = !1), Bz.setAttrib(n, "spellcheck", "false")),
        (t.quirks = nz(t)),
        (function (e) {
          e.fire("PostRender");
        })(t);
    ...
    Vz = function (e, t) {
      var n = oz(e, t);
      t.editorContainer && ((Lz.get(t.editorContainer).style.display = e.orgDisplay), (e.hidden = Lz.isHidden(t.editorContainer))),
        ...
        if (t.getElement() && Kn.contentEditable) {
          ...
          o &&
            ...
            e.hidden_input &&
              ...
              (jz.insertAfter(jz.create("input", { type: "hidden", name: n }), n), (t.hasHiddenInput = !0)),
    ...
    Yz = function (e, t) {
      var n = (function (e) {
        var t;
        return "string" != typeof e
          ? ((t = Jn.extend({ paste: e.paste, data: { paste: e.paste } }, e)), { content: e.content, details: t })
          : { content: e, details: {} };
      })(t);
        ...
        this.addCommands({
          ...
          "Cut,Copy,Paste": function (e) {
            ...
            if (("paste" !== e || n.queryCommandEnabled(e) || (t = !0), t || !n.queryCommandSupported(e))) {
              ...
              Kn.mac && (r = r.replace(/Ctrl\+/g, "\u2318+")), i.notificationManager.open({ text: r, type: "error" });
            }
          },
          unlink: function () {
          ...
          "InsertUnorderedList,InsertOrderedList": function (e) {
            ...
            a.execNativeCommand(e),
              (t = i.dom.getParent(i.selection.getNode(), "ol,ul")) &&
                ((n = t.parentNode),
                /^(H[1-6]|P|ADDRESS|PRE)$/.test(n.nodeName) && (a.storeSelection(), i.dom.split(n, t), a.restoreSelection()));
          },
  ...
  var iE = Jn.makeMap(
    ...
    aE =
      ...
      (uE.prototype.on = function (e, t, n, r) {
        ...
        if ((!1 === t && (t = s), t)) {
          var u = { func: t };
          for (r && Jn.extend(u, r), a = (i = e.toLowerCase().split(" ")).length; a--; )
      ...
      (uE.prototype.off = function (e, t) {
        ...
        if (e)
          for (n = (i = e.toLowerCase().split(" ")).length; n--; ) {
            ...
            if (r) {
              if (t) for (a = r.length; a--; ) r[a].func === t && ((r = r.slice(0, a).concat(r.slice(a + 1))), (this.bindings[e] = r));
              else r.length = 0;
  ...
  function gE(e, t) {
    return "selectionchange" === t
      ...
      ? (e.eventRoot || (e.eventRoot = zE.select(e.settings.event_root)[0]), e.eventRoot)
      : e.getBody();
  }
  function pE(e, t, n) {
    !(function (e) {
  ...
  function bE(t) {
    var n = ut("design"),
      r = ut({ design: { activate: u, deactivate: u, editorReadOnly: !1 }, readonly: { activate: u, deactivate: u, editorReadOnly: !0 } });
    return (
      (function (e) {
        e.serializer
          ? mE(e)
  ...
  var CE,
      ...
      toggleNativeEvent: function (e, t) {
        ...
        "focus" !== e &&
          ...
          (t
            ...
            : n.initialized && (n.dom.unbind(gE(n, e), e, n.delegates[e]), delete n.delegates[e]));
      },
    ...
    SE = Jn.each,
    kE = Jn.explode,
    TE = { f1: 112, f2: 113, f3: 114, f4: 115, f5: 116, f6: 117, f7: 118, f8: 119, f9: 120, f10: 121, f11: 122, f12: 123 },
    ...
    ME =
      ...
      (RE.prototype.parseShortcut = function (e) {
        ...
        for (n in (SE(kE(e.toLowerCase(), "+"), function (e) {
          e in AE
            ...
            : ((r.charCode = e.charCodeAt(0)), (r.keyCode = TE[e] || e.toUpperCase().charCodeAt(0)));
        }),
        (t = [r.keyCode]),
        AE))
          r[n] ? t.push(n) : (r[n] = !1);
      ...
      (RE.prototype.createShortcut = function (e, t, n, r) {
        var o;
        return (
          ((o = Jn.map(kE(e, ">"), this.parseShortcut))[o.length - 1] = Jn.extend(o[o.length - 1], { func: n, scope: r || this.editor })),
  ...
  var _E = Jn.each,
    ...
    PE =
      ...
      (LE.prototype.toAbsPath = function (e, t) {
        ...
        return (
          0 !== (o = (n = u.length - i) <= 0 ? w(a).join("/") : u.slice(0, n).join("/") + "/" + w(a).join("/")).indexOf("/") &&
            (o = "/" + o),
  ...
  var VE = ea.DOM,
    ...
    qE =
      ...
      ($E.prototype.show = function () {
        this.hidden &&
          ((this.hidden = !1),
          this.inline ? (this.getBody().contentEditable = "true") : (VE.show(this.getContainer()), VE.hide(this.id)),
          this.load(),
          this.fire("show"));
      }),
      ($E.prototype.hide = function () {
        ...
        e.hidden ||
          ...
          e.inline
            ...
            : (VE.hide(e.getContainer()), VE.setStyle(e.id, "display", e.orgDisplay)),
          (e.hidden = !0),
          e.fire("hide"));
      }),
      ...
      ($E.prototype.getContent = function (e) {
        return (function (t, n) {
          return (
            void 0 === n && (n = {}),
            D.from(t.getBody()).fold($("tree" === n.format ? new gf("body", 11) : ""), function (e) {
              return wf(t, n, e);
            })
          );
        })(this, e);
      ...
      ($E.prototype.resetContent = function (e) {
        e === undefined ? Gf(this, this.startContent, { format: "raw" }) : Gf(this, e),
  ...
  function $E(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      (this.id = e),
      this.setDirty(!1),
      (this.documentBaseURI = new PE(this.settings.document_base_url, { base_uri: this.baseUri })),
    ...
    aN = ne(ne({}, wE), {
      ...
      setup: function () {
        ...
        if (r) (e = r.base || r.baseURL), (n = r.suffix);
          ...
          if (!e && j.document.currentScript)
            -1 !== (a = j.document.currentScript.src).indexOf(".min") && (n = ".min"), (e = a.substring(0, a.lastIndexOf("/")));
        }
      ...
      init: function (r) {
        var n,
          ...
          c = this;
        u = Jn.makeMap(
          "area base basefont br col frame hr img input isindex link meta param embed source wbr track colgroup option table tbody tfoot thead tr th td script noscript style textarea media audio iframe object menu",
          " "
        );
        function s(e) {
          var t = e.id;
                ...
                : (Jn.each(o, function (e) {
                    !(function (e) {
                      e &&
                        ...
                        (XE(e), e.unbindAllNativeEvents(), e.destroy(!0), (e.removed = !0), (e = null));
                    })(c.get(e.id));
                  }),
                  0 ===
                  (o = Jn.grep(o, function (e) {
                    ...
                    : QE(o, function (e) {
                        !(function (e, t) {
                          ...
                          ? n(s(e), r, e)
                          : fh.initError("Could not initialize inline editor on invalid inline target element", e);
                      }));
          };
        return (
          (c.settings = r),
            ...
            return (
              ...
              H(r.get(n.id))
                ...
                : (XE(n) && r.fire("RemoveEditor", { editor: n }),
                  0 === oN.length && window.removeEventListener("beforeunload", YE),
                  n.remove(),
                  KE(0 < oN.length),
                  n)
            );
      ...
      setActive: function (e) {
        ...
        this.activeEditor !== e && (t && t.fire("deactivate", { relatedTarget: e }), e.fire("activate", { relatedTarget: t })),
          (this.activeEditor = e);
      },
      ...
      send: function (e) {
        ...
        if (
          ...
          if (
            ...
            (t = TN.fire("beforeSend", { xhr: t, settings: e }).xhr).send(e.data),
            !e.async)
          )
            return r();
          Ln.setTimeout(r, 10);
    ...
    MN =
      ...
      (RN.prototype.send = function (e) {
        ...
        (o.success = function (e, t) {
          ...
          (o.data = SN.serialize({ id: e.id || "c" + this.count++, method: e.method, params: e.params })),
  ...
  var BN,
    PN = {
          ...
          function t(e) {
            ...
            return (
              "object" == typeof e
                ...
                ? ((u = parseInt(t[1], 10)), (c = parseInt(t[2], 10)), (s = parseInt(t[3], 10)))
                : (t = /#([0-F]{2})([0-F]{2})([0-F]{2})/gi.exec(e))
                ? ((u = parseInt(t[1], 16)), (c = parseInt(t[2], 16)), (s = parseInt(t[3], 16)))
                : (t = /#([0-F])([0-F])([0-F])/gi.exec(e)) &&
                  ((u = parseInt(t[1] + t[1], 16)), (c = parseInt(t[2] + t[2], 16)), (s = parseInt(t[3] + t[3], 16))),
              (u = u < 0 ? 0 : 255 < u ? 255 : u),
              (c = c < 0 ? 0 : 255 < c ? 255 : c),
              (s = s < 0 ? 0 : 255 < s ? 255 : s),
              n
          ...
          return (
            ...
            (n.toHsv = function () {
              return (function (e, t, n) {
                ...
                return (
                  (o = 0),
                  (i = zN((e /= 255), zN((t /= 255), (n /= 255)))) === (a = EN(e, EN(t, n)))
                    ? { h: 0, s: 0, v: 100 * (o = i) }
                    : ((r = (a - i) / a),
                      {
      ...
      html: { Styles: Wr, Entities: kr, Node: gf, Schema: Lr, SaxParser: hd, DomParser: Xm, Writer: xf, Serializer: zf },
      Env: Kn,
      AddOnManager: xa,
      Annotator: sf,
      Formatter: Yp,
